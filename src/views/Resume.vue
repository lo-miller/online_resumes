        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    <h1 class="mb-0">
                        {{student.firstName}}
                        <span class="text-primary">{{student.lastName}}</span>
                    </h1>
                    <div class="subheading mb-5">
                        3542 Berry Street · Cheyenne Wells, CO 80810 · (317) 585-8468 ·
                        <a href="mailto:name@email.com">name@email.com</a>
                    </div>
                    <p class="lead mb-5">{{student.shortBio}}</p>
                ...
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            <h3 class="mb-0">{{student.experience[0].jobTitle}}</h3>
                            <div class="subheading mb-3">{{student.experience[0].companyName}}</div>
                            <p>{{student.experience[0].details}}</p>
                        </div>
                        <div class="flex-shrink-0"><span class="text-primary">{{student.experience[0].startDate}}- {{student.experience[0].endDate}}</span></div>
                    </div>
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
            ...
            <section class="resume-section" id="education">
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            <h3 class="mb-0">{{student.education[0].universityName}}</h3>
                            <div class="subheading mb-3">{{student.education[0].degree}}</div>
                            <div>{{student.education[0].details}}</div>
                            <p>GPA: 3.23</p>
                        </div>
                        <div class="flex-shrink-0"><span class="text-primary">{{student.education[0].startDate}} - {{student.education[0].endDate}}</span></div>
                    </div>
                    <div class="d-flex flex-column flex-md-row justify-content-between">
                        <div class="flex-grow-1">
            ...
            <section class="resume-section" id="skills">
                <div class="resume-section-content">
                    ...
                    <ul class="fa-ul mb-0" v-for="skill in student.skills">
                        <li>
  ...
  data: function () {
    return {
      ...
      student: {
        ...
        twitterHandle: "twitter handle here",
        personaWebsiteURL: "url here",
        onlineResumeURL: "url",
        githubURL: "url",
        photo: "image",
        personal:
